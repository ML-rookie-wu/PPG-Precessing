...
def cal_real_spo2(parent_dir):
    ...
    for file_path in all_files:
        ...
        while end <= len(ir2):
            ...
            spo2_third, spo2_second, spo2 = cal_spo2_compare(R)
...
def main():
    ...
    save_path = r'D:\my_projects_V1\my_projects\PPG_V1\results\paper_test\model_compare\5disturb_model.xlsx'
    columns_name = ["RealSpo2", "Third", "Second", "First"]
